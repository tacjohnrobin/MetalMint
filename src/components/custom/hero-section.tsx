	...
	return (
		<section className="m-4 md:m-12 h-[500px] mt-24 md:mt-0 lg:h-[600px]  bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-900 text-white overflow-hidden rounded-3xl md:rounded-[40px]">
			<div className="container mx-auto px-4 py-16 md:py-24  px-24 relative max-w-6xl">
				...
				<div
					className="absolute top-0 right-6 w-48 h-48 md:w-72 md:h-84 opacity-90 pointer-events-none z-0 rotate-12"
					style={{
				...
				<div
					className="absolute bottom-50 lg:bottom-[-50%] left-10 md:left-40 bottom-3 w-24 h-24 md:w-72 md:h-72 opacity-90 pointer-events-none z-0 -rotate-6"
					style={{
				...
				<div className="grid grid-cols-1 md:grid-cols-[1fr,0.5fr] gap-8 items-start px-6">
					{/* Left Content */}
					<div className="space-y-6 md:pr-8 pt-12 relative z-10 max-w-3xl">
