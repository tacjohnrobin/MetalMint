...
class PortfolioSnapshot(models.Model):
    ...
    total_invested = models.DecimalField(max_digits=15, decimal_places=2)  # Sum of active investments
    investment_count = models.PositiveIntegerField(default=0)  # Number of active investments
    daily_change = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)  # Day-over-day value change
    ...
    def calculate_daily_change(self):
        ...
        if previous and previous.total_value > 0:
            self.daily_change = ((self.total_value - previous.total_value) / previous.total_value) * 100
